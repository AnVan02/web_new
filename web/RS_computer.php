    ...
    <div id="bannerCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../image/CTTH.png" class="d-block w-100" alt="Banner 1" onclick="window.location.href='https://rosacomputer.vn/.php'">
            </div>
...
<section class="why-choose-section">
    <div class="container">
        ...
        <p class="description">
            <p>
                Trong căn phòng nhỏ của gia đình, nơi luôn ngập tràn máy tính, bo mạch và thiết bị công nghệ, cậu bé <a style="font-weight: bold;">Nguyễn Minh Tuấn </a>  đã sớm nuôi dưỡng giấc mơ 
                chinh phục thế giới công nghệ. Cha anh,người sáng lập và điều hành <a style="font-weight: bold;"> Viết Sơn JSC </a>– một trong những nhà phân phối thiết bị máy tính hàng đầu Việt Nam – chính là người thắp lên ngọn lửa đam mê ấy.
            ...
            <p>Hành trình học tập và làm việc đưa anh đến nhiều quốc gia, từ Canada đến Mỹ, nơi anh nghiên cứu và triển khai các giải pháp robot, trí tuệ nhân tạo và điều khiển thông minh. Mỗi dự án, mỗi sản phẩm mà anh tham gia đều củng cố niềm tin: doanh nghiệp Việt hoàn toàn có thể làm chủ những giải pháp công nghệ tiên tiến ngang tầm quốc tế, nếu có chiến lược đúng đắn và sự kiên định theo đuổi.</p>
                ...
                <h2>TỪ GIẤT MƠ ĐẾN SỨ MỆNH</h2><br>

            <p>Trở về Việt Nam, <a style="font-weight: bold;">Nguyễn Minh Tuấn </a>cùng cha khởi xướng một hành trình mới với việc thành lập  <p><a style="font-weight: bold;"> ROSA Computer </a>. Trên cương vị Giám đốc, anh không chỉ định vị ROSA như một thương hiệu máy tính bền bỉ và mạnh mẽ, mà còn phát triển thành một hệ sinh thái công nghệ toàn diện. Từ phần cứng tối ưu cho doanh nghiệp, phần mềm quản trị, chatbot AI hỗ trợ bán hàng 24/7 đến hệ thống lưu trữ đám mây Nextcloud Server, mỗi giải pháp đều được thiết kế nhằm nâng cao hiệu quả vận hành và thúc đẩy doanh nghiệp Việt bứt phá trong kỷ nguyên số.</p>
            ...
            <p>Ngày nay, ROSA Computer không chỉ là niềm tự hào của gia đình <a style="font-weight: bold;"> Viết Sơn JSC </a>, mà còn là minh chứng sống động cho tinh thần dám nghĩ dám làm, cho khát vọng chinh phục công nghệ và cho sứ mệnh đồng hành cùng hàng ngàn doanh nghiệp Việt trên con đường chuyển đổi số. Mỗi chiếc máy tính, mỗi giải pháp phần mềm ROSA mang đến thị trường đều hàm chứa một cam kết: giúp doanh nghiệp Việt không chỉ theo kịp, mà còn tiên phong dẫn dắt xu thế công nghệ. </p>
