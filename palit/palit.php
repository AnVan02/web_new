...
document.addEventListener("DOMContentLoaded", function() {
  ...
  destop.addEventListener("click", function() {
    mobileMenu.classList.add("actice");
  })
...
<!-- code hiện thị trên deptop -->
 ...
 <!-- Banner Desktop -->
<section class="hero">
  <img src="nen.png" alt="GeForce RTX 50 Series" alt="dblock w-100"   onclick="window.location.href='../web/RS_computer.php'"style="width:100%; height:auto;" />
</section>
<section class="hero">
  <img src="palit_kk.png" alt="GeForce RTX 50 Series" alt="dblock w-100"   onclick="window.location.href='../web/RS_computer.php'"style="width:100%; height:auto;" />
</section>


<section class="palit-mobile-card">
  <div class="palit-mobile-card-inner">
    <img class="palit-mobile-card-img" src="111.png" alt="GeForce RTX 50 Series" style="maxt-width:10%; height:auto;" />
...
<section class="hero">
  <img src="Palit 4X@4x.png" alt="GeForce RTX 50 Series" alt="dblock w-100"   onclick="window.location.href='../web/RS_computer.php'"style="width:90%; height:auto;" />
</section>
...
<!-- nội dung trang  -->
    <!-- <div class="container blackwell-section">
        <div class="image-container">
            <img class="main-content-image" src="image5.png" alt="NVIDIA AI Platform"/>
        </div>
        ...
        <div class="container product-section">
          <h2>Bộ sưu tập hình ảnh</h2>
            <div class="product-list">
              <div class="product" >
                  <a href="https://rosacomputer.vn/sanpham/ROSA-GAMER-PALIT1.php"><img src="Group 21 (2).png" alt="RTX 5060"></a>
              </div>
              <div class="product">
                  <a href="https://rosacomputer.vn/sanpham/ROSA-GAMER-PALIT2.php"><img src="Group 21 (2).png" alt="RTX 5070"></a>
              </div>
              <div class="product">
                  <a href="https://rosacomputer.vn/sanpham/ROSA-GAMER-PALIT3.php"><img src="Group 21 (2).png" alt="RTX 5080"></a>
              </div>
            </div>
        </div>
...
.desktop-header .container {
  display: flex;
  justify-content: space-between; /* Logo - Nav - Hamburger chia đều */
  align-items: center;
}
