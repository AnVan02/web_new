...
<body>
    ...
    <div class="header-top">
        <div class="logo_brand">
            ...
            <!--<div class="brand_text">THƯƠNG HIỆU MÁY TÍNH BỘ HÀNG ĐẦU VIỆT NAM</div>-->
        </div>
        <div class="contact_info">
            <span><i class="fa fa-phone"></i>(028) 39260996 - (028) 39293765</span>
        ...
        <div class="container d-flex align-items-center justify-content-between py-2">
            ...
            <nav class="nav_container d-none d-md-block">
                <ul class="d-flex">
                    ...
                    <li><a href="#">AI SOLUTIONS <i class="fas fa-chevron-down"></i></a>
                        <ul class="submenu">
                    ...
                    <!--<li><a href="https://rosacomputer.vn/pages/main/index.php?page=products&brand_id=4">SẢN PHẨM KHÁC</a></li>-->
    ...
    <div class="hamburger_menu">
        ...
        <div class="hamburger_menu_content">
            <ul class="menu_top_nav">
                ...
                <li class="has-submenu">
                    <a href="javascript:void(0)" class="submenu-toggle">AI SOLUTIONS <i class="fas fa-chevron-down" style="margin-left: 15px"></i></a>
                    <ul class="submenu">
                        <li class="has-submenu">
    ...
    @media (max-width: 768px) {
        ...
        .logo_container img {
            max-width: 120px; /* Matches the visible width in the image */
            height: auto; /* Maintains aspect ratio */
            vertical-align: middle; /* Aligns the image vertically with adjacent text */
            margin-right: 20px; /* Adds spacing between the logo and "TRANG CHỦ" */
        }
        .brand_text {
            font-size: 13px;
        ...
        .nav_container ul li a {
            ...
            color: #333;
            font-size: 15px;
            /* padding: 8px 15px; Increased padding for better spacing and uniformity */
