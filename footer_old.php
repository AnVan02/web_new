        ...
        <div class="rosa-footer-sections">
            ...
            <div class="rosa-footer-column">
                ...
                <ul class="rosa-list-info">
                    <li><a href="/danhsachdaily.php"><i class="fas fa-angle-right" style="color: #FF0000; margin-right: 5px;"></i>DANH SÁCH ĐẠI LÝ</a></li>
                    <li><a href="/chinhsachbaohanh.php"><i class="fas fa-angle-right" style="color: #FF0000; margin-right: 5px;"></i>CHÍNH SÁCH BẢO HÀNH</a></li>
                    <li><a href="/chinhsachbaomat.php"><i class="fas fa-angle-right" style="color: #FF0000; margin-right: 5px;"></i>CHÍNH SÁCH BẢO MẬT</a></li>
            ...
            <div class="rosa-footer-column">
                <h3 style="color:red;font-weight: bold;">CHƯƠNG TRÌNH ROSA</h3>
                <ul class="rosa-list-info">
                    ...
                    <li><a href="/courses/palit.php"><i class="fas fa-angle-right" style="color: #FF0000; margin-right: 5px;"></i>CHƯƠNG TRÌNH PALIT</a></li>
                </ul>
            </div>
            <div class="rosa-footer-column">
...
<div class="contact-fixed">
    ...
    <div id="chatbot-popup" style="display:none; position: fixed; bottom: 5px; right: 10px; width: 480px; height: 600px; border: 1px solid #ccc; background: #fff;  z-index: 2147483647; position: fixed; box-shadow: 0 4px 16px rgba(0,0,0,0.2); border-radius: 8px; overflow: hidden;">
        ...
        <iframe src="https://server1.rosachatbot.com/Rosa" width="100%" height="100%" style="border: none;"></iframe>
    </div>
