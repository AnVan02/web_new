...
<div class="banner-side left">
    <a href="#" target="_blank">
        <img src="assets/images/kkk.jpg" alt="Banner Khuyến Mãi Trái">
    </a>
</div>
    ...
    <div class="container pd-bottom">
        ...
        <div class="row">
            ...
            <div class="col" style="--w-md:9;">
                ...
                <!-- Banner ngang giữa trang (hiển thị sau 3 sản phẩm đầu) -->
                <?php
                $product_count = 0;
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <?php
                        // Hiển thị banner ngang sau sản phẩm thứ 3 và chỉ hiển thị 1 lần
                        if ($product_count == 3 && !$banner_displayed) {
                ...
                <!-- <div class="row">
                    <div class="col">
                        <div class="banner-horizontal">
                            <a href="#" target="_blank">
                                <img src="/assets/images/banner-horizontal.jpg" alt="Banner Khuyến Mãi Lớn">
                            </a>
                        </div>
                    </div>
                </div> -->
...
<script>
    ...
    // Hiệu ứng cho banner bên
    document.addEventListener('DOMContentLoaded', function() {
        const leftBanner = document.querySelector('.banner-side.left');
        const rightBanner = document.querySelector('.banner-side.right');
        
        // Ẩn banner khi scroll xuống quá nhiều
        window.addEventListener('scroll', function() {
            const scrollY = window.scrollY;
            const windowHeight = window.innerHeight;
            
            if (scrollY > windowHeight * 2) {
                leftBanner.style.opacity = '0.5';
                rightBanner.style.opacity = '0.5';
            } else {
